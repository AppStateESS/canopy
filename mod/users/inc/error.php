...
USER_ERR_PASSWORD_LENGTH  => sprintf('Password must be at least %s characters in length.', PASSWORD_LENGTH),
...
USER_ERR_FAIL_ON_SUBPERM  => 'Module tried to detect a non-existent permission.',
